        ...
        <div class="overflow-x-auto bg-[var(--bg-primary)]">
            <table class="w-full text-sm text-left">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-[var(--border-color)] hover:bg-[var(--bg-elevated)] transition-colors bg-[var(--accent-primary)]/5">
                        <td class="p-5 font-bold text-[var(--accent-primary)] align-top flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
                            Metrik Efisiensi
                        </td>
                        @foreach($group['items'] as $item)
                        <td class="p-5 border-l border-[var(--border-color)] align-top">
                            <span class="inline-block bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-md px-3 py-1 text-sm font-semibold text-[var(--text-primary)] shadow-sm">{{ $item['analytics']['cost_per_feature'] }}</span>
                        </td>
                        @endforeach
                    </tr>
                    <tr class="hover:bg-[var(--bg-elevated)] transition-colors bg-[var(--accent-primary)]/10">
                        <td class="p-5 font-bold text-[var(--accent-primary)] align-top flex items-center gap-2">
                        ...
                        @foreach($group['items'] as $item)
                        <td class="p-5 border-l border-[var(--border-color)] align-top">
                            <p class="text-sm font-medium text-[var(--text-secondary)] leading-relaxed">{{ $item['analytics']['switching_roi'] }}</p>
                        </td>
                        @endforeach
                    </tr>
                    @endif
