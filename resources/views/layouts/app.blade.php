    ...
    <aside class="admin-sidebar" :class="{ 'open': sidebarOpen }">
        ...
        <div class="flex-1 overflow-y-auto py-4 px-3 hide-scrollbar">
            ...
            <div class="flex items-center gap-2 mt-4 px-3 mb-2">
                <p class="text-[10px] font-bold text-[#4b5e78] uppercase tracking-wider">Administrator</p>
                <span class="bg-red-500/20 text-red-400 border border-red-500/30 text-[8px] font-bold px-1.5 py-0.5 rounded-sm">KHUSUS ADMIN</span>
            </div>
